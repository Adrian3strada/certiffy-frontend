<template>
  <section :id="'imagen-texto-izquierda-' + (id || Math.random().toString(36).substring(2, 9))" class="q-mx-auto q-my-sm q-px-sm" style="max-width: 1080px; width: 100%; position: relative;">
